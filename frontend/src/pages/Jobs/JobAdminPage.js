                        ...
                        <Widget key={job.id} className="flex flex-col bg-[#00000033] justify-between p-4 rounded-2xl shadow-[0_0_0.5vh_rgba(0,0,0,0.5)] gap-4">
                            ...
                            <div className="mt-2 flex justify-end gap-2">
                                ...
                                <button
                                    ...
                                    className="transition-colors duration-150 px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-24 shadow-[0_0_0.5vh_rgba(0,0,0,0.5)]"
                                >
                                    Remove
                                </button>
                            </div>
                    ...
                    {(modalType === 'edit' || modalType === 'create') && selectedJob && (
                        <div className="overflow-y-scroll max-h-[80vh]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <Input
                                    className='py-1 px-2 text-sm overflow-y-scroll rounded-lg border-2 border-[#00000033] focus:outline-none'
                                    type='text'
                                    name="Name"
                                ...
                                <label className="mt-4">Job Type:</label>
                                <Input
                                    className='py-1 px-2 text-sm overflow-y-scroll rounded-lg border-2 border-[#00000033] focus:outline-none'
                                    type='text'
                                    name="Type"
                                    placeholder="Part-time / Full-time / Contract / Internship"
                                ...
                                <div className="mt-4">
                                    ...
                                    {selectedJob.Requirements && selectedJob.Requirements.map((req, index) => (
                                        <div key={index} className="flex items-center mt-2">
                                            <Input
                                                className='flex w-full py-1 px-2 text-sm rounded-lg border-2 border-[#00000033] focus:outline-none'
                                                type="text" 
