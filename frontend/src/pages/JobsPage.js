                            ...
                            <div className=" mb-4 mt-2 mx-10 h-[100%] flex flex-col">
                                ...
                                <>
                                    <div className='grow overflow-auto pb-10'>
                                        ...
                                        <p className='lg:max-h-[50rem] lg:min-h-[50rem]'>{jobs[jobIndex].desc}</p>
                                    </div>
                                    <hr className='mb-4'></hr>
                                    <div className='h-fit py-2'>
                                        {jobs[jobIndex].applyExternally &&
                                            <a href={jobs[jobIndex].link}>
                                    ...
                                    <GenericModal
                                        ...
                                        <div className='px-4 py-2 flex flex-row w-full justify-evenly gap-10'>
                                            <div>
                                                ...
                                                <br/>                          
                                                <a href={"mailto:" + jobs[jobIndex].contact} className='underline text-blue-500 text-2xl' >{jobs[jobIndex].contact}</a>
                                            </div>
                                            <div>
