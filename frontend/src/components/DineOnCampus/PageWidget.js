            ...
            {locations.map((location, index) => {
                return (
                    ...
                    >
                        ...
                        <div
                            className={`flex flex-row items-center h-10 rounded-r-full bg-gradient-to-r from-5% from-transparent to-10% ${location.isOpen ? 'to-green-500' : (location.statusMessage.includes('Closing') ? 'to-yellow-300' : 'to-red-500')}`}
                        >
