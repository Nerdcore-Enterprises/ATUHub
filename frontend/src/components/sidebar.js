        ...
        <>
            ...
            <div className={(isSidebarOpen ? 'opened' : 'closed') + " sidebar h-screen fixed max-w-80 bg-zinc-300 space-y-4 p-4 shadow-[0_0_5vh_rgba(0,0,0,0.7)] "} onClick={handleModalClick}>
                <NavButton to={'home/'} onClick={() => setIsSidebarOpen(false)}>
                    <img src={logo} alt="ATUHub" className="m-auto w-64 max-w-screen-md invert cursor-pointer"></img>
                </NavButton>

                <div className="bg-zinc-600 h-1 mt-auto rounded-full"></div>
                <NavButton to={'weather'} onClick={() => setIsSidebarOpen(false)}>
                ...
                <NavButton to={'dineoncampus'} onClick={() => setIsSidebarOpen(false)}>
                    <button className="w-full text-left">
                ...
                <NavButton to={'transportation'} onClick={() => setIsSidebarOpen(false)}>
                    <button className="w-full text-left">
                ...
                <NavButton to={'jobs'} onClick={() => setIsSidebarOpen(false)}>
                    <button className="w-full text-left">
                        ...
                        <div className="flex space-x-4">
                            <div className="flex-grow">
                                {new NavWidget(
                                    ...
                                    <button className="flex flex-row items-center w-full text-left">
